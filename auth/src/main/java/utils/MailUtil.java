...
public class MailUtil {
	...
	public static String templatePassReset(String link) {
		return """
			<!DOCTYPE html><html><head><meta charset="UTF-8">
			    <title>Please Verify your E-Mail for HridayKh.in</title>
			    <style>body{font-family:Arial,sans-serif;background-color:#f9f9f9;padding:20px}.container{max-width:600px;margin:auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 0 10px rgba(0,0,0,.05)}h2{color:#333}p{color:#555}.btn{display:inline-block;padding:10px 20px;background-color:#007bff;color:#fff;text-decoration:none;border-radius:5px}</style>
			</head><body><div class="container">
			    <h2>Reset your password!</h2>
			    <p>Click this link to reset your account's password.</p>
	...
	public static void sendMail(String sendTo, String subject, String content) {
		...
		mailgunMessagesApi.sendMessage("auth.hridaykh.in", msgBuild.build());
	}
}
